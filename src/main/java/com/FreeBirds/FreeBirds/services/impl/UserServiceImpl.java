...
import com.FreeBirds.FreeBirds.entities.Education;
import com.FreeBirds.FreeBirds.entities.Project;
import com.FreeBirds.FreeBirds.entities.Skill;
...
public class UserServiceImpl implements UserService {
    ...
    public Response getMyContract() {
        ...
        return Response.builder()
                ...
                .data(contractRepository.findByUser_Id(currentUser.getId()))
                .build();
    }
